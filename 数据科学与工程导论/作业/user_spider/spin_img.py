...
class my_ocr():
    def __init__(self):
        ...
        self.model = tf.keras.models.load_model(os.path.abspath("旋转验证码.hdf5"), custom_objects={'angle_error':self.angle_error})
    ...
    def rotate_img(self,img, angle):
        ...
        cv2.imencode('1.png', rotated_img)[1].tofile('2.png')
